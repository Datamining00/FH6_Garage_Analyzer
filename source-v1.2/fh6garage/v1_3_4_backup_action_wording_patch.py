...
from .v1_4_preview_mode_patch import apply_v1_4_preview_mode_patch
...
def apply_v1_3_4_backup_action_wording_patch(MainWindow: Any) -> None:
    """Apply only the backup wording/action behavior."""
...
def apply_v1_3_4_v1_4_followup_patches(MainWindow: Any) -> None:
    """Install the legacy follow-up stack explicitly after the wording patch.

    This preserves the previously verified order while removing the hidden side
    effect where the wording patch itself installed unrelated feature layers.
    """
    ...
    apply_v1_4_preview_mode_patch(MainWindow)
