...
class CarOpenGLWidget(QOpenGLWidget):
    ...
    def __init__(self, scene_data: GlbSceneData, livery_textures: DirectLiveryTextures | None = None, parent=None) -> None:
        ...
        self._zoom_label.setStyleSheet('background: white; color: #4e329c; border: 1px solid #dfe1e8; border-radius: 5px; padding: 4px 8px;')
        self._zoom_label.setAttribute(Qt.WidgetAttribute.WA_TransparentForMouseEvents)
        self._zoom_label.move(12, 12)
        self.reset_camera()

    def update_zoom_label(self):
        from .preview_presentation_patch import HOME_DISTANCE_RADIUS
        percent = 100 * self._radius * HOME_DISTANCE_RADIUS / max(self._distance, 1e-6)
    ...
    def reset_camera(self) -> None:
        from .preview_presentation_patch import HOME_YAW_DEG, HOME_PITCH_DEG, HOME_DISTANCE_RADIUS
