...
def rebuild_record_indexes(self: Any) -> None:
    """Build constant-time content indexes for the active scan result."""
    ...
    self._fh6_v132_livery_record_by_key = livery_by_key
    self._fh6_record_by_key = {
        "livery": livery_by_key,
