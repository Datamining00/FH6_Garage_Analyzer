...
def process_livery_refresh(
    ...
    # Older versions tracked SoulBound records too. Do not report their
    # exclusion from monitoring as deletion during the first refresh.
    old_entries = [entry for entry in old_entries if entry.kind in _TRACKED_KINDS]
