...
def apply_v1_3_2_responsiveness_sort_patch(MainWindow: Any) -> None:
    ...
    def patched_begin_busy(self: Any, message: str | None = None) -> None:
        original_begin_busy(self, message)
        self._fh6_busy_last_yield = 0.0
        _yield_busy_events(self, force=True)

    MainWindow.__init__ = patched_init
    MainWindow._begin_busy = patched_begin_busy
