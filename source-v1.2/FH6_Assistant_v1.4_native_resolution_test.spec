...
if not vendor_root.is_dir():
    raise SystemExit(
        ...
        'Run the v1.4 Native Resolution Test build workflow or populate source-v1.2/vendor/kfps first.'
    )
...
exe = EXE(
    ...
    a.datas,
    [],
    name='FH6 Assistant v1.4 Native Resolution Test',
    debug=False,
    ...
    version=str(project_root / 'version_info_native_resolution_test.txt'),
)
