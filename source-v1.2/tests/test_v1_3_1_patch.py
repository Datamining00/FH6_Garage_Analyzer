...
class V131BuildMetadataTests(unittest.TestCase):
    def test_app_version_and_patch_order(self) -> None:
        ...
        self.assertIn('app.setApplicationVersion("1.5.1")', source)
    ...
    def test_windows_version_metadata_is_current_release(self) -> None:
        ...
        self.assertIn("filevers=(1, 5, 1, 0)", source)
        self.assertIn("prodvers=(1, 5, 1, 0)", source)
        self.assertIn("FH6 Assistant v1.5.1.exe", source)
        self.assertIn("ProductVersion', '1.5.1'", source)
