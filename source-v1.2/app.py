...
from fh6garage.v1_3_4_backup_action_wording_patch import apply_v1_3_4_backup_action_wording_patch
...
def main() -> int:
    ...
    # This also installs the final backup/filter/performance layers.
