...
if not vendor_root.is_dir():
    raise SystemExit(
        ...
        'Run the independent render test build workflow or populate source-v1.2/vendor/kfps first.'
    )
...
exe = EXE(
    ...
    a.datas,
    [],
    name='FH6 Assistant v1.4 Independent Render Test',
    debug=False,
    ...
    version=str(project_root / 'version_info_independent_render_test.txt'),
)
