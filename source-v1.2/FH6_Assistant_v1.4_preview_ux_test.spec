...
if not vendor_root.is_dir():
    raise SystemExit(
        ...
        'Run the v1.4 Preview UX Test build workflow or populate source-v1.2/vendor/kfps first.'
    )
...
a = Analysis(
    ...
    hiddenimports=[
        ...
        'fh6garage.livery_preview_mask_semantics',
        'fh6garage.livery_preview_tiled_quality',
        'fh6garage.livery_preview_ui_state',
        'fh6garage.v1_4_preview_final_ui_patch',
        'psutil',
    ],
    hookspath=[],
    hooksconfig={},
...
exe = EXE(
    ...
    a.datas,
    [],
    name='FH6 Assistant v1.4 Preview UX Test',
    debug=False,
    ...
    version=str(project_root / 'version_info_preview_ux_test.txt'),
)
