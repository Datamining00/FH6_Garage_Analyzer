...
if not vendor_root.is_dir():
    raise SystemExit(
        ...
        'Run the v1.4 Quality Pipeline Test build workflow or populate source-v1.2/vendor/kfps first.'
    )
...
exe = EXE(
    ...
    a.datas,
    [],
    name='FH6 Assistant v1.4 Quality Pipeline Test',
    debug=False,
    ...
    version=str(project_root / 'version_info_quality_pipeline_test.txt'),
)
